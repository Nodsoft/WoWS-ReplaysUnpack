...
namespace Nodsoft.WoWsReplaysUnpack.UnitTests.GameVersion_0_10_11;
...
public class ReplayParsingTest
{
	...
	{
		_replayStream = File.OpenRead(TestHelper.GetTestFilePath("0.10.11.wowsreplay"));
	}
	...
	public void ParseReplay_VerifyMetadata()
	{
		...
		arenaInfo.ClientVersionFromXml.Should().StartWith("0,10,11");
