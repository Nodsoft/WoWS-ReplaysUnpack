...
public sealed class ReplayUnpackerTests
{
	...
	public static IEnumerable<object[]> GetReplayFileList()
	{
		...
		yield return ["14.3.wowsreplay"];
		yield return ["14.4.wowsreplay"];
		yield return ["14.5.wowsreplay"];
		yield return ["14.6.wowsreplay"];
		yield return ["14.7.wowsreplay"];
		yield return ["14.7.1.wowsreplay"];
		yield return ["14.8.wowsreplay"];
		yield return ["14.9.wowsreplay"];
		yield return ["14.10.wowsreplay"];
		yield return ["14.11.wowsreplay"];
		yield return ["15.0.wowsreplay"];
		yield return ["15.1.wowsreplay"];
		yield return ["15.2.wowsreplay"];
		yield return ["15.3.wowsreplay"];
		yield return ["15.4.wowsreplay"];
